...
app.get("/url/sentiment", (req,res) => {
    ...
    let promise = naturalLanguageUnderstanding.analyze(analyzeParams);
    promise.then(analysisResults => {
        return res.send(analysisResults.result.keywords[0].sentiment,null,2)
    })
    .catch(err => {
        return res.send("Falied to retireve sentiment result"+err)
    })
});
...
app.get("/text/emotion", (req,res) => {
    ...
    .catch(err => {
        return res.send("Falied to retireve emotion result"+err)
    })
});
